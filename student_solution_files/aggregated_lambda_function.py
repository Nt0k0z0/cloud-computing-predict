...
def email_response(name, critical_phrase_list, list_of_extracted_phrases, AWS_Comprehend_Sentiment_Dump):
    ...
    # Function Constants
    SENDER_NAME = 'Ntokozo Valentia Dlalisa'
...
def lambda_handler(event, context):
    ...
    table = dynamodb.Table('ntokozo_database')
    ...
    # --- Insert your code here ---
    key_phrases = comprehend.detect_phrase(Text= enquiry_text, LanguageCode='en') ['key_phrase'] # <--- Insert code to get the key phrases with AWS comprehend
    # -----------------------------
    ...
    email_text = email_response =(dec_dict['name'], phrases, sentiment)

    
    # -----------------------------
# Sample text that you would like to email to your recipient 
    # address from your sender address.
    email_text = 'Hey I'm Ntokozo, how can I help?'
